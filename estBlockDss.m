function [dss_out,w] = estBlockDss(y_sub_dct,y_image, sigma, C,repeat_height, repeat_width)
% img1 = y_sub_dct;
% img2 = y_sub_dct;
...
for m = 1:8
   for n = 1:8
        ...
        for qpstep=1:255
             img1Decomp(m:8:end, n:8:end) = round(img2Decomp(m:8:end, n:8:end)/qpstep)*qpstep;%量化反量化
%              img1Decomp = dct_decomp(img1Decomp);
